...
from textual.widgets import Header, Footer, Input, Select, Button
...
class ToolApp(App):
    ...
    """def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        fileExtension = ".csv"
        filename = 'trc-logs\\TextualReplayTESTlog1PACM-{date:%Y-%m-%d_%H-%M-%S}.{extension}'.format(date=datetime.datetime.now(),extension=fileExtension)
